...
pub mod org {
    ...
    pub mod apache {
     ...
     .finish();
                ...
                impl<'a> RecordBatch<'a> {
                    ...
                    pub fn nodes(&self) -> Option<flatbuffers::Vector<'a, FieldNode>> {
                        ...
                        unsafe {
                            self._tab.get::<flatbuffers::ForwardsUOffset<
                                flatbuffers::Vector<'a, FieldNode>,
                            >>(RecordBatch::VT_NODES, None)
                        }
                    }
                    ...
                    pub fn buffers(&self) -> Option<flatbuffers::Vector<'a, Buffer>> {
                        ...
                        // which contains a valid value in this slot
                        unsafe {
                            self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Buffer>>>(RecordBatch::VT_BUFFERS, None)
                        }
                    }
     ...
     .finish();
                ...
                #[inline]
                pub fn finish_size_prefixed_message_buffer<
                    'a,
                    'b,
