    ...
    pub mod apache {
        ...
        pub mod arrow {
            ...
            pub mod flatbuf {
                ...
                pub const ENUM_VALUES_DATE_UNIT: [DateUnit; 2] =
                    [DateUnit::DAY, DateUnit::MILLISECOND];
                ...
                impl<'a> Buffer {
                    ...
                    pub fn offset(&self) -> i64 {
                        let mut mem =
                            core::mem::MaybeUninit::<<i64 as EndianScalar>::Scalar>::uninit();
                        // Safety:
                ...
                impl<'a> Block {
                    ...
                    pub fn metaDataLength(&self) -> i32 {
                        let mut mem =
                            core::mem::MaybeUninit::<<i32 as EndianScalar>::Scalar>::uninit();
                        // Safety:
                        // Created from a valid Table for this object
                        // Which contains a valid value in this slot
                        EndianScalar::from_little_endian(unsafe {
                ...
                impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> DictionaryEncodingBuilder<'a, 'b, A> {
                    ...
                    pub fn add_isOrdered(&mut self, isOrdered: bool) {
                        self.fbb_.push_slot::<bool>(
                            DictionaryEncoding::VT_ISORDERED,
                            isOrdered,
                            false,
                        );
                    }
     ...
     .finish();
                ...
                impl<'a> Footer<'a> {
                    ...
                    pub fn schema(&self) -> Option<Schema<'a>> {
                        ...
                        // which contains a valid value in this slot
                        unsafe {
                            self._tab.get::<flatbuffers::ForwardsUOffset<Schema>>(
                                Footer::VT_SCHEMA,
                                None,
                            )
                        }
                    ...
                    pub fn dictionaries(&self) -> Option<flatbuffers::Vector<'a, Block>> {
                        ...
                        // which contains a valid value in this slot
                        unsafe {
                            self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Block>>>(Footer::VT_DICTIONARIES, None)
                        }
                    }
                    #[inline]
                    pub fn recordBatches(&self) -> Option<flatbuffers::Vector<'a, Block>> {
                        ...
                        // which contains a valid value in this slot
                        unsafe {
                            self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Block>>>(Footer::VT_RECORDBATCHES, None)
                        }
                    }
                    /// User-defined metadata
                    #[inline]
     ...
     .finish();
                ...
                pub struct FooterArgs<'a> {
                    ...
                    pub dictionaries:
                        Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, Block>>>,
                    pub recordBatches:
                        Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, Block>>>,
                    pub custom_metadata: Option<
                        flatbuffers::WIPOffset<
                ...
                #[inline]
                pub fn finish_size_prefixed_footer_buffer<
                    'a,
                    'b,
