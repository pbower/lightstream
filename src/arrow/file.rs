...
impl Type {
  ...
  pub const Timestamp: Self = Self(9);
  pub const Interval: Self = Self(10);
  pub const Map: Self = Self(11);
  pub const Duration: Self = Self(12);
  pub const LargeBinary: Self = Self(13);
...
impl<'b> flatbuffers::Push for Buffer {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const Buffer as *const u8, Self::size()) };
...
impl<'b> flatbuffers::Push for Block {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = unsafe { ::core::slice::from_raw_parts(self as *const Block as *const u8, Self::size()) };
        dst.copy_from_slice(src);
    }
}
...
impl<'a> Footer<'a> {
  ...
  pub fn version(&self) -> MetadataVersion {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<MetadataVersion>(Footer::VT_VERSION, Some(MetadataVersion::V1)).unwrap()}
  }
  #[inline]
  pub fn schema(&self) -> Option<Schema<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<Schema>>(Footer::VT_SCHEMA, None)}
  }
  #[inline]
  pub fn dictionaries(&self) -> Option<flatbuffers::Vector<'a, Block>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Block>>>(Footer::VT_DICTIONARIES, None)}
  }
  #[inline]
  pub fn recordBatches(&self) -> Option<flatbuffers::Vector<'a, Block>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, Block>>>(Footer::VT_RECORDBATCHES, None)}
  }
  /// User-defined metadata
  #[inline]
  pub fn custom_metadata(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<KeyValue<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<KeyValue>>>>(Footer::VT_CUSTOM_METADATA, None)}
  }
}
...
impl flatbuffers::Verifiable for Footer<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, Block>>>("dictionaries", Self::VT_DICTIONARIES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, Block>>>("recordBatches", Self::VT_RECORDBATCHES, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<KeyValue>>>>("custom_metadata", Self::VT_CUSTOM_METADATA, false)?
     .finish();
    Ok(())
  }
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> FooterBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_custom_metadata(&mut self, custom_metadata: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<KeyValue<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Footer::VT_CUSTOM_METADATA, custom_metadata);
  }
  #[inline]
