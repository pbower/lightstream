...
use minarrow::{ffi::arrow_dtype::CategoricalIndexType, ArrowType};
...
pub (crate) enum ParquetLogicalType {
    ...
    #[cfg(feature = "datetime")]
    TimeNanos,
    IntType { bit_width: u8, is_signed: bool }
}
...
impl ParquetLogicalType {
    ...
    pub fn from_converted_type(id: Option<i32>) -> Option<Self> {
        match id {
            ...
            Some(11) => Some(ParquetLogicalType::IntType { bit_width: 8, is_signed: true }),
            Some(12) => Some(ParquetLogicalType::IntType { bit_width: 16, is_signed: true }),
            Some(13) => Some(ParquetLogicalType::IntType { bit_width: 32, is_signed: true }),
            Some(14) => Some(ParquetLogicalType::IntType { bit_width: 64, is_signed: true }),
            Some(15) => Some(ParquetLogicalType::IntType { bit_width: 8, is_signed: false }),
            Some(16) => Some(ParquetLogicalType::IntType { bit_width: 16, is_signed: false }),
            Some(17) => Some(ParquetLogicalType::IntType { bit_width: 32, is_signed: false }),
            Some(18) => Some(ParquetLogicalType::IntType { bit_width: 64, is_signed: false }),
    ...
    match ty {
        ...
        #[cfg(feature = "extended_numeric_types")]
           ArrowType::Int8 => Ok((
                ...
                ParquetLogicalType::IntType { bit_width: 8, is_signed: true }
            )),
        #[cfg(feature = "extended_numeric_types")]
            ArrowType::Int16 => Ok((
                ParquetPhysicalType::Int32,
                ParquetLogicalType::IntType { bit_width: 16, is_signed: true }
            )),
        ArrowType::Int32 => Ok((
                ParquetPhysicalType::Int32,
                ParquetLogicalType::IntType { bit_width: 32, is_signed: true }
            )),
        ArrowType::Int64 => Ok((
                ParquetPhysicalType::Int64,
                ParquetLogicalType::IntType { bit_width: 64, is_signed: true }
            )),
        #[cfg(feature = "extended_numeric_types")]
            ArrowType::UInt8 => Ok((
                ParquetPhysicalType::Int32,
                ParquetLogicalType::IntType { bit_width: 8, is_signed: false }
            )),
        #[cfg(feature = "extended_numeric_types")]
            ArrowType::UInt16 => Ok((
                ParquetPhysicalType::Int32,
                ParquetLogicalType::IntType { bit_width: 16, is_signed: false }
            )),
        ArrowType::UInt32 => Ok((
                ParquetPhysicalType::Int32,
                ParquetLogicalType::IntType { bit_width: 32, is_signed: false }
            )),
        ArrowType::UInt64 => Ok((
                ParquetPhysicalType::Int64,
                ParquetLogicalType::IntType { bit_width: 64, is_signed: false }
            )),
        ArrowType::Dictionary(CategoricalIndexType::UInt32) => { // TODO: Fix for non Cat32
        ...
        #[cfg(feature = "datetime")]
            ArrowType::Timestamp(unit) => match unit {
                TimeUnit::Milliseconds => {
                    Ok((ParquetPhysicalType::Int64, ParquetLogicalType::TimestampMillis))
                }
                TimeUnit::Microseconds => {
                    Ok((ParquetPhysicalType::Int64, ParquetLogicalType::TimestampMicros))
                }
                TimeUnit::Nanoseconds => {
                    Ok((ParquetPhysicalType::Int64, ParquetLogicalType::TimestampNanos))
                }
                TimeUnit::Seconds => {
                    Ok((ParquetPhysicalType::Int64, ParquetLogicalType::TimestampMillis))
                } // best-effort
...
pub (crate) fn parquet_to_arrow_type(
    ...
    match (physical, logical.clone()) {
        ...
        #[cfg(feature = "extended_numeric_types")]
        (ParquetPhysicalType::Int32, Some(ParquetLogicalType::IntType { bit_width: 8, is_signed: true })) => Ok(ArrowType::Int8),
        #[cfg(feature = "extended_numeric_types")]
        (ParquetPhysicalType::Int32, Some(ParquetLogicalType::IntType { bit_width: 16, is_signed: true })) => Ok(ArrowType::Int16),
        (ParquetPhysicalType::Int32, Some(ParquetLogicalType::IntType { bit_width: 32, is_signed: true })) => Ok(ArrowType::Int32),
        #[cfg(feature = "extended_numeric_types")]
        (ParquetPhysicalType::Int32, Some(ParquetLogicalType::IntType { bit_width: 8, is_signed: false })) => Ok(ArrowType::UInt8),
        #[cfg(feature = "extended_numeric_types")]
        (ParquetPhysicalType::Int32, Some(ParquetLogicalType::IntType { bit_width: 16, is_signed: false })) => Ok(ArrowType::UInt16),
        (ParquetPhysicalType::Int32, Some(ParquetLogicalType::IntType { bit_width: 32, is_signed: false })) => Ok(ArrowType::UInt32),
        (ParquetPhysicalType::Int64, Some(ParquetLogicalType::IntType { bit_width: 64, is_signed: true })) => Ok(ArrowType::Int64),
        (ParquetPhysicalType::Int64, Some(ParquetLogicalType::IntType { bit_width: 64, is_signed: false })) => Ok(ArrowType::UInt64),
        ...
        #[cfg(feature = "datetime")]
        (ParquetPhysicalType::Int64, Some(ParquetLogicalType::TimestampMillis)) => Ok(ArrowType::Timestamp(TimeUnit::Milliseconds)),
        #[cfg(feature = "datetime")]
        (ParquetPhysicalType::Int64, Some(ParquetLogicalType::TimestampMicros)) => Ok(ArrowType::Timestamp(TimeUnit::Microseconds)),
        #[cfg(feature = "datetime")]
        (ParquetPhysicalType::Int64, Some(ParquetLogicalType::TimestampNanos)) => Ok(ArrowType::Timestamp(TimeUnit::Nanoseconds)),
        #[cfg(feature = "datetime")]
        (ParquetPhysicalType::Int32, Some(ParquetLogicalType::TimeMillis)) => Ok(ArrowType::Time32(TimeUnit::Milliseconds)),
        #[cfg(feature = "datetime")]
        (ParquetPhysicalType::Int32, Some(ParquetLogicalType::TimeMicros)) => Ok(ArrowType::Time32(TimeUnit::Microseconds)),
        #[cfg(feature = "datetime")]
        (ParquetPhysicalType::Int32, Some(ParquetLogicalType::TimeNanos)) => Ok(ArrowType::Time32(TimeUnit::Nanoseconds)),
        #[cfg(feature = "datetime")]
        (ParquetPhysicalType::Int64, Some(ParquetLogicalType::TimeMillis)) => Ok(ArrowType::Time64(TimeUnit::Milliseconds)),
        #[cfg(feature = "datetime")]
        (ParquetPhysicalType::Int64, Some(ParquetLogicalType::TimeMicros)) => Ok(ArrowType::Time64(TimeUnit::Microseconds)),
        #[cfg(feature = "datetime")]
        (ParquetPhysicalType::Int64, Some(ParquetLogicalType::TimeNanos)) => Ok(ArrowType::Time64(TimeUnit::Nanoseconds)),
        ...
        #[cfg(feature = "large_string")]
        (ParquetPhysicalType::ByteArray, Some(ParquetLogicalType::Utf8)) => Ok(ArrowType::LargeString),

        // Fallback: treat byte array without logical utf8 as unsupported
        (ParquetPhysicalType::ByteArray, None) => Err(IoError::UnsupportedType("Binary not supported".into())),
